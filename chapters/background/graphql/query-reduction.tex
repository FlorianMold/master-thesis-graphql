...
This section describes the theory behind reducing queries with existing data inside the cache. Apollo Client does not offer this behavior by default. The GitHub repository of Apollo Client includes many feature requests (\href{https://github.com/apollographql/apollo-client/issues/2977}{2977}, \href{https://github.com/apollographql/apollo-client/issues/2872}{2872}, \href{https://github.com/apollographql/apollo-feature-requests/issues/104}{104}, \url{https://github.com/apollographql/apollo-client/issues/2425}{2425}) that want such a feature implemented for queries. So far, this did not happen. The following section describes how the theory behind reduction works.
