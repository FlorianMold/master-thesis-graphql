...
render<Comp extends ElementType>(rootEl: Root, Comp: Comp) {
  ...
  \end{minted}
  \caption{The function to render a React widget into an Angular component.}\label{code:applied-methods:prototypical-implementation:render-react-component-with-context}
\end{listing}
\fi
...
return (
  <ApolloProvider client={client}>
    ...
    \end{minted}
    \caption{The function to get the \texttt{InMemoryCache} instance from the React context.}\label{code:applied-methods:prototypical-implementation:consume-react-context}
\end{listing}
\fi
